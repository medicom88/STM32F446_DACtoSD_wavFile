...
//	unsigned char	ChunkSize[4];
//	unsigned char	AudioFormat[2];	// PCM = 1
//	unsigned char	NumChannels[2];	// Mono = 1, Stereo = 2, etc.
//	unsigned char	SampleRate[4];		// 8000, 44100, etc.
//	unsigned char	AvgByteRate[4];	// SampleRate * NumChannels * BitsPerSample/8
//	unsigned char	BlockAlign[2];		// NumChannels * BitsPerSample/8
//	unsigned char	BitPerSample[2];	// 8 bits = 8, 16 bits = 16, etc } FMT;
}FMT_TypeDef;
...
extern volatile WAVE_HDR__TypeDef WaveHdr_test;
